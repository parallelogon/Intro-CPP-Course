...
public:
    ...
    int fourInRow(char character); //four 'x's in any row 'wins'
...
int Gameboard::fourInRow(char character)
{
	int win = 0;
	...
	for(int ii = 0; ii < 4 ; ii++)
	{
		if(gameSpace[ii][3-ii] != character)
		{
			win = 0;
			break;
		}
